<?php namespace Zalmanzhao\Kubernetes;
...
use Zalmanzhao\Kubernetes\Exceptions\BadRequestException;
use Zalmanzhao\Kubernetes\Exceptions\MissingOptionException;
use Zalmanzhao\Kubernetes\Repositories\ConfigMapRepository;
use Zalmanzhao\Kubernetes\Repositories\CronJobRepository;
use Zalmanzhao\Kubernetes\Repositories\DaemonSetRepository;
use Zalmanzhao\Kubernetes\Repositories\DeploymentRepository;
use Zalmanzhao\Kubernetes\Repositories\EndpointRepository;
use Zalmanzhao\Kubernetes\Repositories\EventRepository;
use Zalmanzhao\Kubernetes\Repositories\IngressRepository;
use Zalmanzhao\Kubernetes\Repositories\JobRepository;
use Zalmanzhao\Kubernetes\Repositories\NodeRepository;
use Zalmanzhao\Kubernetes\Repositories\PersistentVolumeClaimRepository;
use Zalmanzhao\Kubernetes\Repositories\PodRepository;
use Zalmanzhao\Kubernetes\Repositories\ReplicaSetRepository;
use Zalmanzhao\Kubernetes\Repositories\ReplicationControllerRepository;
use Zalmanzhao\Kubernetes\Repositories\SecretRepository;
use Zalmanzhao\Kubernetes\Repositories\ServiceRepository;
use Zalmanzhao\Kubernetes\Repositories\NamespaceRepository;
...
class Client
{
	...
	public function __call($name, $args)
	{
		if (isset($this->classMap[$name])) {
			$class = 'Zalmanzhao\Kubernetes\\' . $this->classMap[$name];
