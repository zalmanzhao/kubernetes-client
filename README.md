# Kubernetes Client
[![Build Status](https://api.travis-ci.org/zalmanzhao/kubernetes-client.svg?branch=master)](https://travis-ci.org/Zalmanzhao/kubernetes-client)
...
```bash
$ composer require zalmanzhao/kubernetes-client
```
...
use Zalmanzhao\Kubernetes\Client;
...
```php
use Zalmanzhao\Kubernetes\Models\ReplicationController;
